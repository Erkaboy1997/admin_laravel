...
<head>
    ...
    <link rel="stylesheet" href="http://codepen.io/api/oembed/?url=http://codepen.io/FWeinb/pen/wjzyH&format=js&callback=coolDude">
    ...
    {{--<script src="https://oembed.fwdeveryone.com/static/embedable.js"></script>--}}
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{route('admin.admin')}}">Admin page</a>
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="#">Vokansies</a>
