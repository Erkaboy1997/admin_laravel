...
<head>
    ...
    <link href="{{asset('sdmin/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
...
<body  style="background-image: url({{asset('gifs/FavorableAstonishingKestrel-max-1mb.gif')}});background-size:cover;background-repeat: no-repeat;">

<div class="container"  >
    <div class="card card-login mx-auto mt-5" style="background-color: #4c110f;opacity: 1">
